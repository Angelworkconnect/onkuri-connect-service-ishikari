...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/CareAdditionAI" element={<LayoutWrapper currentPageName="CareAdditionAI"><CareAdditionAIPage /></LayoutWrapper>} />
      <Route path="/TrialContractAI" element={<LayoutWrapper currentPageName="TrialContractAI"><TrialContractAIPage /></LayoutWrapper>} />
