...
import { ChevronLeft, ChevronRight, Heart, Calendar, Pencil } from 'lucide-react';
...
export default function MyShift() {
  ...
  const { data: entries = [] } = useQuery({
    ...
    queryFn: async () => {
      return await base44.entities.ShiftEntry.filter({ shift_month_id: currentShiftMonth.id });
    },
