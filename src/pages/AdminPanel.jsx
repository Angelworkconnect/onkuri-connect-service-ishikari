...
import { 
        ...
        Eye, EyeOff, Sparkles, Settings, Gift, MessageCircle, Send
      } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 -mt-6">
        <Tabs defaultValue="settings" className="w-full">
            ...
            <TabsTrigger value="transport" className="data-[state=active]:bg-[#2D4A6F] data-[state=active]:text-white text-xs sm:text-sm">
              <span className="hidden sm:inline">送迎管理センター</span>
          ...
          <TabsContent value="transport">
            <div className="bg-white rounded-xl shadow p-8 text-center">
              ...
              <a href={`/${createPageUrl('TransportAdmin')}`}>
                <Button className="bg-amber-500 hover:bg-amber-600 text-white text-lg px-8 py-4 h-auto">
                  送迎管理センターを開く →
                </Button>
              </a>
            </div>
