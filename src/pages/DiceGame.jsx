...
const prizes = {
  ...
  4: { name: 'アイス', points: 40, emoji: '🍦', color: 'from-blue-400 to-blue-500' },
  5: { name: 'ランチ券', points: 50, emoji: '🍱', color: 'from-green-400 to-green-500' },
  6: { name: '特別賞', points: 100, emoji: '🎁', color: 'from-purple-400 to-purple-500' }
};
